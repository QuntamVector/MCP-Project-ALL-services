...
const MODELS = [
  {
    ...
    icon: '🎯',
    color: '#4f8ef7',
    desc: 'Best balance of intelligence and speed for most tasks.',
  ...
  },
  {
    ...
    icon: '🏆',
    color: '#a855f7',
    desc: 'Most powerful model for complex tasks requiring deep reasoning.',
    tags: ['Complex', 'Research', 'Advanced'],
    ctx: '200K tokens',
    rpm: '500',
  },
  {
    ...
    icon: '⚡',
    color: '#3ecf8e',
    desc: 'Fastest and most compact model for high-throughput tasks.',
    tags: ['Fast', 'Lightweight', 'Classify'],
    ctx: '200K tokens',
    rpm: '5,000',
  },
]
